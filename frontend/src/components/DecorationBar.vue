...
<template>
    <div id="dragable-bar" class="fixed top-0 left-0 w-screen h-8 flex" style="--drag-region: y" @dblclick="update()">
        <div class="mr-0.5 ml-auto flex group" v-if="Architecture != 'darwin'">
            <button
                ...
                <i class="icon-[ic--round-minus] size-4 -mx-2" />
            </button>
            <button
                ...
                tabindex="-1"
                @click="update">
                <i class="icon-[ic--round-fullscreen] size-4 -mx-2" v-if="!isFullscreen" />
                <i class="icon-[ic--round-fullscreen-exit] size-4 -mx-2" v-else />
            </button>
            <button
                ...
                tabindex="-1"
                @click="Quit()">
                <i class="icon-[ic--round-close] size-4 -mx-2" />
            </button>
        </div>
